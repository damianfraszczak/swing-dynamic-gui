...
import pl.edu.wat.wcy.swingdynamicgui.FormConstants;
...
import pl.edu.wat.wcy.swingdynamicgui.form.services.defaults.DefaultDynamicFormValidator;
...
public class DynamicFormContext {
    ...
    public List<FormGroup> getAllFormGroups() {
        if (formConfig.getFormGroups().isEmpty()) {
            return Arrays.asList(new FormGroup("", FieldSize.ONE, metadata
